                  ...
                  <div className="space-y-4">
                    {mode === "register" && (
                      <input
                        ...
                        className={`w-full rounded-xl border-none bg-white/5 px-5 py-3 text-sm outline-none transition-all duration-300 placeholder:text-muted-foreground ${hasError ? "shadow-[0_0_0_2px_#ef4444]" : "focus:bg-white/10 focus:scale-[1.01]"}`}
                      />
                    )}
                      ...
                      <div className="space-y-1.5">
                        <div className="relative">
                          <input
                            ...
                            className={`w-full rounded-xl border-none bg-white/5 px-5 py-3 pr-12 text-sm outline-none transition-all duration-300 placeholder:text-muted-foreground ${hasError ? "shadow-[0_0_0_2px_#ef4444]" : "focus:bg-white/10 focus:scale-[1.01]"}`}
                          />
                          <button
                            type="button"
