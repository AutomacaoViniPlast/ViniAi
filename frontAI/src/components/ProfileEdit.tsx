...
import { X, Camera, Save, User, Briefcase, Shield, Trash2 } from "lucide-react";
    ...
    >
      <div className="flex-1 flex flex-col items-center justify-center p-4 md:p-8">
        <div className="w-full max-w-2xl bg-card rounded-[2.5rem] overflow-hidden relative">
          {/* Design do Cabeçalho - Padrão Mesh Profissional */}
          ...
          <div className="px-8 pb-10 -mt-14 relative z-10">
            <div className="flex flex-col items-center">
              {/* Foto de Perfil - Iniciais/Imagem com Círculo Decorativo */}
              ...
              <form onSubmit={handleSave} className="w-full mt-8 space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                  ...
                  {/* Entrada de Setor - Apenas Leitura */}
                  <div className="space-y-1.5">
                    <label className="text-[10px] font-bold uppercase tracking-widest text-muted-foreground/60 px-1">
                      Setor / Departamento
                    </label>
                ...
                {/* Exibição de Informações - Nível de Acesso com Vermelho Primário */}
                <div className="p-4 rounded-3xl bg-primary/[0.04] border border-primary/0 flex items-center gap-4">
                  <div className="w-12 h-12 rounded-2xl bg-primary flex items-center justify-center text-white shrink-0">
                    <Shield size={20} />
                  </div>
                  <div>
                    <p className="text-[10px] font-bold uppercase tracking-widest text-primary/60 leading-none mb-1">Status da Conta</p>
